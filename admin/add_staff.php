...
<?php
	...
	$status=1;
	 ...
	 $query = mysqli_query($conn,"select * from tblemployees where EmailId = '$email'")or die("query incorrect.....");
...
<?php
        ...
        mysqli_query($conn,"INSERT INTO tblemployees(FirstName,LastName,EmailId,Password,Gender,Dob,Department,Address,Av_leave,role,Phonenumber,Status, location) VALUES('$fname','$lname','$email','$password','$department','$address','$user_role','$phonenumber','$status', 'NO-IMAGE-AVAILABLE.jpg')         
