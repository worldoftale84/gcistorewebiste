                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mb-30">
                        <div class="pd-20 card-box height-100-p">
                            ...
                            <?php $query= mysqli_query($conn,"select * from tblemployees LEFT JOIN tbldepartments ON tblemployees.Department = tbldepartments.DepartmentShortName where emp_id = '$session_id'")or die('');
                                                    ...
                                                    <div class="form-group">
                                                        <div class="custom-file">
                                                            <input name="image" id="file" type="file"
                                                                ...
                                                                onchange="validateImage('file')">
                                                            <label class="custom-file-label" for="file"
                                                                id="selector">Choose file</label>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="tab-pane fade show active" id="timeline" role="tabpanel">
                                            <div class="pd-20">
                                                <div class="profile-timeline">
                                                    <?php $query= mysqli_query($conn,"SELECT * from tblleaves where empid = '$session_id'")or die();
																while ($row = mysqli_fetch_array($query)) {
		                        								$id = $row['id'];
															?>
                                                    <div class="timeline-month">
                                                        <h5><?php echo date('d M Y', strtotime($row['PostingDate'])); ?>
                                                        </h5>
                                                    </div>
                                                    <div class="profile-timeline-list">
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <div class="date"><?php echo $row['num_days']; ?> Days
                                                                </div>
                                                                <div class="task-name"><i
                                                                        class="ion-ios-chatboxes"></i><?php echo $row['LeaveType']; ?>
                                                                </div>
                                            ...
                                            <div class="profile-setting">
                                                <form method="POST" enctype="multipart/form-data">
                                                    <div class="profile-edit-list row">
                                                        ...
                                                        <?php
														$query = mysqli_query($conn,"select * from tblemployees where emp_id = '$session_id' ")or die('');
														$row = mysqli_fetch_array($query);
														?>
                                                        ...
                                                        <div class="weight-500 col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input name="lastname"
                                                                    ...
                                                                    placeholder="" required="true" autocomplete="off"
                                                        ...
                                                        <div class="weight-500 col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="department"
                                                                    class="custom-select form-control" required="true"
                                                                    autocomplete="off">
                                                                    <?php
																		$query_staff = mysqli_query($conn,"select * from tblemployees join  tbldepartments where emp_id = '$session_id'")or die('');
																		$row_staff = mysqli_fetch_array($query_staff);
																		
																	 ?>
                                                                    <option
                                                                        value="<?php echo $row_staff['DepartmentShortName']; ?>">
                                                                        <?php echo $row_staff['DepartmentName']; ?>
                                                                    </option>
                                                                    <?php
																		...
																		?>
                                                                    <option
                                                                        value="<?php echo $row['DepartmentShortName']; ?>">
                                                        ...
                                                        <div class="weight-500 col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="modal-footer justify-content-center">
                                                                    <button class="btn btn-primary" name="new_update"
                                                                        id="new_update" data-toggle="modal">Save &
                                                                        &nbsp;Update</button>
                                                                </div>
                                                            </div>
                                                        </div>
